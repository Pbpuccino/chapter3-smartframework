...
public final class ClassUtil {
    ...
    private static void addClass(Set<Class<?>> classSet, String packagePath, final String packageName){
        File[] files = new File(packagePath).listFiles(new FileFilter() { public boolean accept(File file) {
        ...
        for (File file : files){
            ...
            if (file.isFile()){
                ...
                if (StringUtil.isNotEmpty(packageName)){
                    subPackageName = packageName + "." + packageName;
                }
